...
public class RconController {
	...
	public String kickPlayer(@PathVariable int id) throws TimeoutException,
	...
	public String banPlayer(@PathVariable int id) throws TimeoutException,
			SteamCondenserException {
	...
	public String addBot(@PathVariable String value,
			@MatrixVariable String team, @MatrixVariable int diff)
			throws TimeoutException, SteamCondenserException {
